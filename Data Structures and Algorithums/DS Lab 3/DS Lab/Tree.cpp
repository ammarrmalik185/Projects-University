...
public:
    ...
    string printJson(Node *n){
        ...
        if (n->left == nullptr && n->right == nullptr)
            ...
            string s = to_string(n->value) + " { Left - " + printJson(n->left) + " } ";
            return s;
        }

        else if (n->left == nullptr){
            string s = to_string(n->value) + " { Right - " + printJson(n->right) + " } ";
            return s;
        }

        else{

            string s = to_string(n->value) + " { Left - " + printJson(n->left) + " , Right - " + printJson(n->right) + " } ";
            return s;
        }
    }
