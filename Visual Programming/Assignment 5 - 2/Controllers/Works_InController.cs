...
namespace Assignment_5___2.Controllers
{
    public class Works_InController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,employeeId,departmentId")] Works_In works_In)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,employeeId,departmentId")] Works_In works_In)
        {
            if (ModelState.IsValid)
            {
